function g_s_key1_table(hParent, txt4, f1)
...
skey_table = uitable(f1,'Data',trc_hdr_info(:,1:2),'ColumnName',{'Description','Abbreviation'},...
    ...
    'ColumnWidth',{180, 60},'CellSelectionCallback', {@cell_cbk, hParent, trc_hdr_info, txt4});

function cell_cbk(hObject, eventdata, hParent, trc_hdr_info, txt4)
handles = guidata(hParent);
s_key = eventdata.Indices;
handles.s_key1 = {s_key(1) trc_hdr_info{s_key(1),2}};
guidata(hParent,handles);
set(txt4,'String',handles.s_key1{2});
delete(gcf);
